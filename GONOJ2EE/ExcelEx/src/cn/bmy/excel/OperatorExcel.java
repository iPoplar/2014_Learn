...
public class OperatorExcel 
{
	...
	public static void writeExcel(String fileName)
	{
		...
		{
			//创建一个可写入的工作表
			//Workbook的createSheet方法有两个参数，第一个是工作表的名称，
			//第二个是工作表在工作薄中的位置
			WritableSheet ws = wwb.createSheet("sheet1", 0);
			for(int i = 0; i < 10; i++)//循环增加单元格
			{
				for(int j = 0; j < 5; j++)
				{
	 ...
	 */
	public static void writeContentToExcel(String fileName) throws IOException, RowsExceededException, WriteException
	{
		...
		//预定义一些字体和格式，同一个Excel中最好不要有太多格式  字形 大小  加粗  倾斜  下划线  颜色
	...
	public static void readExcelInfo(String fileName) throws BiffException, IOException
	{
		//获得EXcel文件多少行多少列
